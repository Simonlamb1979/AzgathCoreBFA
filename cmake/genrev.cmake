...
if(WITHOUT_GIT)
  set(rev_date "2023-01-01 00:00:00 +0800")
  set(rev_hash "84b28563abfa")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"84b285633bfa 2023-01-01 00:00:00 (AzgathCoreBFA)\"")
    set(rev_date "2023-01-01 00:00:00 +0800")
    set(rev_hash "84b285633bfa")
    set(rev_branch "AzgathCoreBFA")
  else()
