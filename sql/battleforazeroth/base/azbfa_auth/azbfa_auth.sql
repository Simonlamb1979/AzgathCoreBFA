...
MySQL - 10.5.8-MariaDB : Database - azbfa_auth
*********************************************************************
*/
...
CREATE TABLE `battlenet_accounts` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Account System';
...
(704,'Command: reload azgath_string'),
...
(1,'Az\'gathCore 8.3.7','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,10,0,0,35662,1,1);
...
('$/sql/battleforazeroth/updates/auth','RELEASED');
...
(1,1623529881,0,0,'AzgathCore rev. bd4e718435cf 2021-06-12 21:08:13 +0200 (AzgathCoreBFA branch) (Win64, Release, Static)');
